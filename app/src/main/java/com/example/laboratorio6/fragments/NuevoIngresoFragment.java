...
public class NuevoIngresoFragment extends Fragment {
    ...
    private void crearIngreso() {
        ...
        if (currentUser != null) {
            ...
            ingresoData.put("fecha", FieldValue.serverTimestamp()); // Guardar la fecha como un timestamp
            ...
            db.collection("ingresos")
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(getContext(), "Error al crear el ingreso", Toast.LENGTH_SHORT).show();
                            // Manejo de errores
                        }
                    });
        }
